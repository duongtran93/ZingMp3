<div class="position-ref">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <a class="navbar-brand" href="#"><img src="{{ asset('storage/images/logo2.png') }}" alt="" style="width: 100px; height: 40px"></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <div class="nav-item dropdown" style="padding-right: 40px">
